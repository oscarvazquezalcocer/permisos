    ...
    <section>
        <div class="center-container3">
            <div class="align-middle">
                <div id="texto-derecha">
                    ...
                    <button type="button" class="btn-close" aria-label="Close"
                        onclick="window.location.href = 'Inicio2.php'"></button>
                </div>
            </div>
            <div id="texto-izquierda">
                ...
                <div>
                    <form id="form12" class="formulario" method="POST" action="status.php?id=<?php echo $solicitudID; ?>">
                        ...
                        <div class="modal fade" id="modalAceptar" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form method="POST" action="status.php?id=<?php echo $solicitudID; ?>">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="modalAceptarLabel">Esta seguro?</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                             <div class="modal-body">
                                                <p>Por favor confirma si desea Aceptar la Solicitud.</p>
                                             </div>
